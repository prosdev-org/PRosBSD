...
static uint16_t cgraph_svgacolor[] = {
...
// 640x480x8
static uint16_t cseq_640x480x8[] = {
...
static uint16_t ccrtc_640x480x8[] = {
    0x2c11,
...
// 640x480x16/15
static uint16_t cseq_640x480x16[] = {
...
static uint16_t ccrtc_640x480x16[] = {
    0x2c11,
    0x5f00,0x4f01,0x4f02,0x8003,0x5204,0x1e05,0x0b06,0x3e07,
    0x4009,0x000c,0x000d,
...
// 640x480x24
static uint16_t cseq_640x480x24[] = {
...
static uint16_t ccrtc_640x480x24[] = {
    0x2c11,
    0x5f00,0x4f01,0x4f02,0x8003,0x5204,0x1e05,0x0b06,0x3e07,
    0x4009,0x000c,0x000d,
...
// 800x600x8
static uint16_t cseq_800x600x8[] = {
    0x0300,0x2101,0x0f02,0x0003,0x0e04,0x1107,
...
static uint16_t ccrtc_800x600x8[] = {
...
// 800x600x16/15
static uint16_t cseq_800x600x16[] = {
    0x0300,0x2101,0x0f02,0x0003,0x0e04,0x1707,
    0x230b,0x230c,0x230d,0x230e,
    0x0412,0x0013,0x2017,
    0x141b,0x141c,0x141d,0x141e,
...
static uint16_t ccrtc_800x600x16[] = {
    0x2311,0x7d00,0x6301,0x6302,0x8003,0x6b04,0x1a05,0x9806,0xf007,
    0x6009,0x000c,0x000d,
...
// 800x600x24
static uint16_t cseq_800x600x24[] = {
    0x0300,0x2101,0x0f02,0x0003,0x0e04,0x1507,
    0x230b,0x230c,0x230d,0x230e,
    0x0412,0x0013,0x2017,
    0x141b,0x141c,0x141d,0x141e,
...
static uint16_t ccrtc_800x600x24[] = {
    0x2311,0x7d00,0x6301,0x6302,0x8003,0x6b04,0x1a05,0x9806,0xf007,
    0x6009,0x000c,0x000d,
...
// 1024x768x8
static uint16_t cseq_1024x768x8[] = {
    0x0300,0x2101,0x0f02,0x0003,0x0e04,0x1107,
...
static uint16_t ccrtc_1024x768x8[] = {
...
// 1024x768x16/15
static uint16_t cseq_1024x768x16[] = {
    0x0300,0x2101,0x0f02,0x0003,0x0e04,0x1707,
    0x760b,0x760c,0x760d,0x760e,
    0x0412,0x0013,0x2017,
    0x341b,0x341c,0x341d,0x341e,
...
static uint16_t ccrtc_1024x768x16[] = {
    0x2911,0xa300,0x7f01,0x7f02,0x8603,0x8304,0x9405,0x2406,0xf507,
    0x6009,0x000c,0x000d,
...
// 1024x768x24
static uint16_t cseq_1024x768x24[] = {
    0x0300,0x2101,0x0f02,0x0003,0x0e04,0x1507,
    0x760b,0x760c,0x760d,0x760e,
    0x0412,0x0013,0x2017,
    0x341b,0x341c,0x341d,0x341e,
...
static uint16_t ccrtc_1024x768x24[] = {
    0x2911,0xa300,0x7f01,0x7f02,0x8603,0x8304,0x9405,0x2406,0xf507,
    0x6009,0x000c,0x000d,
    0x0310,0xff12,0x8013,0x4014,0xff15,0x2416,0xc317,0xff18,
    0x001a,0x321b,0x001d,
...
// 1280x1024x8
static uint16_t cseq_1280x1024x8[] = {
    0x0300,0x2101,0x0f02,0x0003,0x0e04,0x1107,
    0x760b,0x760c,0x760d,0x760e,
    0x0412,0x0013,0x2017,
    0x341b,0x341c,0x341d,0x341e,
...
static uint16_t ccrtc_1280x1024x8[] = {
...
// 1280x1024x16/15
static uint16_t cseq_1280x1024x16[] = {
    0x0300,0x2101,0x0f02,0x0003,0x0e04,0x1707,
    0x760b,0x760c,0x760d,0x760e,
    0x0412,0x0013,0x2017,
    0x341b,0x341c,0x341d,0x341e,
...
static uint16_t ccrtc_1280x1024x16[] = {
    0x2911,0xc300,0x9f01,0x9f02,0x8603,0x8304,0x9405,0x2406,0xf707,
    0x6009,0x000c,0x000d,
...
static uint16_t cseq_1600x1200x8[] = {
    0x0300,0x2101,0x0f02,0x0003,0x0e04,0x1107,
    0x760b,0x760c,0x760d,0x760e,
    0x0412,0x0013,0x2017,
    0x341b,0x341c,0x341d,0x341e,
...
static uint16_t ccrtc_1600x1200x8[] = {
    0x2911,0xc300,0x9f01,0x9f02,0x8603,0x8304,0x9405,0x2406,0xf707,
    0x6009,0x000c,0x000d,
...
static const cirrus_mode_t* find_cirrus_mode(uint8_t bios_code) {
    for (size_t i = 0; i < sizeof(cirrus_modes)/sizeof(cirrus_modes[0]); i++) {
        if (cirrus_modes[i].code == bios_code) return &cirrus_modes[i];
    }
    return NULL;
}
...
static void cirrus_set_mode_raw(const cirrus_mode_t* m) {
    ...
    // program hidden DAC
    outb(0x00, 0x3C6); (void)inb(0x3C6); (void)inb(0x3C6); (void)inb(0x3C6); (void)inb(0x3C6);
...
void vga_init(vga_mode_t mode) {
    if (mode == CIRRUS_320x200x8) {
        ...
        outb(0x00, 0x3C4); outb(0x03, 0x3C5);
        outb(0x01, 0x3C4); outb(0x01, 0x3C5);
        outb(0x02, 0x3C4); outb(0x0F, 0x3C5);
        outb(0x03, 0x3C4); outb(0x00, 0x3C5);
        outb(0x04, 0x3C4); outb(0x0E, 0x3C5);

        // unlock CRTC
        outb(0x11, 0x3D4); outb(0x00, 0x3D5);
        ...
        for (uint8_t i = 0; i < 25; i++) {
            outb(i, 0x3D4); outb(crtc_regs[i], 0x3D5);
        }

        outb(0x00, 0x3CE); outb(0x00, 0x3CF);
        outb(0x01, 0x3CE); outb(0x00, 0x3CF);
        outb(0x02, 0x3CE); outb(0x00, 0x3CF);
        outb(0x03, 0x3CE); outb(0x00, 0x3CF);
        outb(0x04, 0x3CE); outb(0x00, 0x3CF);
        outb(0x05, 0x3CE); outb(0x40, 0x3CF);
        outb(0x06, 0x3CE); outb(0x05, 0x3CF);
        outb(0x07, 0x3CE); outb(0x0F, 0x3CF);
        outb(0x08, 0x3CE); outb(0xFF, 0x3CF);

        for (uint8_t i = 0; i < 0x10; i++) {
            (void)inb(0x3DA); outb(i, 0x3C0); outb(i, 0x3C0);
        }
        (void)inb(0x3DA); outb(0x20, 0x3C0);

        vga_width = 320; vga_height = 200; vga_bpp = 8; vga_stride = 320;
        return;
    }
    ...
    if (m) {
        ...
        if (def) cirrus_set_mode_raw(def);
    }
}
